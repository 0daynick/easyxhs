...
use OverNick\Easyxhs\Kernel\Exceptions\RuntimeException;
...
{
    /**
     * @throws \OverNick\Easyxhs\Kernel\Exceptions\RuntimeException
     */
    ...
    public static function fromContents(
        ...
        if ($contentType === null) {
            ...
            if ($filename) {
                ...
                $tmp = tempnam(sys_get_temp_dir(), 'OverNick\Easyxhs');
                if (! $tmp) {
     ...
     *
     * @deprecated since OverNick\Easyxhs 7.0, use fromContents() instead
     */
