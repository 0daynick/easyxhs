...
use OverNick\Easyxhs\Kernel\Contracts\AccessTokenAwareHttpClient as AccessTokenAwareHttpClientInterface;
use OverNick\Easyxhs\Kernel\Traits\MockableHttpClient;
